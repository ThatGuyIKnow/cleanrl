...
if __name__ == "__main__":
    ...
    def step_once(carry, step, env_step_fn):
        ...
        static_embedding = rnd_static.apply(agent_state.params.rnd_static_params, obs)
        predictor_embedding = rnd_static.apply(agent_state.params.rnd_predict_params, obs)
