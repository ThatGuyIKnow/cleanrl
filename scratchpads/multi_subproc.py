...
class SubprocVecEnv(VecEnv):
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        self.waiting = False
        obs, rews, dones, truncateds, infos, self.reset_infos = zip(*results)
        return _flatten_obs(obs, self.observation_space), np.stack(rews), np.stack(dones), np.stack(truncateds), infos
