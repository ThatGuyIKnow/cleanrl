...
class Args:
    ...
    wandb_project_name: str = 'gridworld-rnd-v2-unified-dk8x8-masked2'
    """track the experiment"""
    repeats: int = 10
...
if __name__ == '__main__':
    ...
    # Construct commands
    base_cmd = f"python cleanrl/ppo_rnd_gridworld_unified.py  --ext-coef 5.0 --ent-coef 0.001 --learning-rate 0.00005 --device " + "{0}"
    if args.track:
