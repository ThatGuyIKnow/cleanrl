...
class Args:
    ...
    wandb_project_name: str = 'gridworld-rnd-v2-unified-hp'
    """track the experiment"""
    repeats: int = 2
...
if __name__ == '__main__':
    ...
    # Construct commands
    base_cmd = f"python cleanrl/ppo_rnd_gridworld_unified.py  --ext-coef 2.0 --ent-coef 0.01 --learning-rate 0.00005 --device " + "{0}"
    if args.track:
