...
class Args:
    ...
    wandb_project_name: str = 'gridworld-rnd-v2-doorkey16x16-no-template'
    """track the experiment"""
    repeats: int = 10
...
env_ids_and_tags = [
    ...
    ('Visual/DoorKey16x16-Gridworld-v0' + ' --total-timesteps 5000000 --int-coef 0.05 --update_epochs 8 --update_proportion 0.15 --ext-coef 5.0 --num-envs 16 --num-steps 400 --no-use-template', 'doorkey16x16'),
    ...
    # ('Visual/MultiRoomS5N6-Gridworld-v0'  + ' --total-timesteps 6000000 --int-coef 0.05 --no-use-template --update_epochs 8 --update_proportion 0.15', 'multiroomS5N6'),
