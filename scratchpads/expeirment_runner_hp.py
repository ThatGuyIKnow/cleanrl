...
env_ids_and_tags = [
    ...
    ('Visual/DoorKey8x8-Gridworld-v0' + ' --total-timesteps 5000000 --int-coef 0.000001 --masking-pretraining-steps 0 --no-use-template --num_steps 400 --num_envs 20', 'doorkey8x8'),
